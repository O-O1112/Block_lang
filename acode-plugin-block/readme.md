...
- **Hardened Security**: Support for `X-Api-Token` security headers.
- **Hotkeys**: Press `Ctrl+R` or `Cmd+R` to execute current Block script.
- **Local Imports**: Compose reviewed project files with explicit `<import src="..." />` directives.
