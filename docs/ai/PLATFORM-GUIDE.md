...
1. `SYSTEM-PROMPT.md` — behavior, terminology, safety boundaries, and response
   rules.
2. `block-knowledge.md` — canonical v2.2.5 reference facts.
...
3. Add conversation starters such as:
   ...
   - `Diagnose this Windows path-discovery error in Block v2.2.5.`
...
same `eval-cases.jsonl` in CI or a private evaluation job. Keep the v2.2.5
...
> You are learning Block Language v2.2.5. Use the attached policy as behavior
...
- identify v2.2.5 as the knowledge version.
