...
Historical packages remain at the root for backwards compatibility. Website
links normally target versioned GitHub Release assets. Before moving or removing
an artifact, search both `main` and `gh-pages` for references and verify the
public URL.
