...
| `BlockSetup-v2.2.6.exe`, `block-language-2.2.6.vsix`, `acode-plugin-block-2.2.6.zip` | v2.2.6 release assets generated by `build-release.ps1` and published by the tag workflow. |
