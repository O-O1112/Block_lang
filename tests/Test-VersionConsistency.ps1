...
Assert-Contains 'block-vscode-extension\extension.vsixmanifest' ('Version="' + $version + '"')
...
if ($vscode.version -ne $version) { throw "VS Code package version is $($vscode.version), expected $version." }
